...
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { m[0] }]; #IO_L17N_T2_A25_15 Sch=led[2]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { m[1] }]; #IO_L8P_T1_D11_14 Sch=led[3]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { m[2] }]; #IO_L7P_T1_D09_14 Sch=led[4]
