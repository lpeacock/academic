...
HD_PWD='C:/Temp/lucaspeacock/FPGA/Lab2/lab2_2_2/lab2_2_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdto2outof5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcdto2outof5.tcl
