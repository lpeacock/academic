...
HD_PWD='C:/Temp/lucaspeacock/FPGA/Lab2/lab2_2_2/lab2_2_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcdto2outof5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcdto2outof5.tcl -notrace
