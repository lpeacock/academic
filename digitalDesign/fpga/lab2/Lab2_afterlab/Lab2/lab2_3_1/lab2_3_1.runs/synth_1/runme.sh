...
HD_PWD='C:/Users/lucas/Documents/fpga/lab2/Lab2_afterlab/Lab2/lab2_3_1/lab2_3_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fulladder_dataflow_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fulladder_dataflow_tb.tcl
