...
#
# Generated by export_simulation on Wed Feb 05 22:34:23 -0600 2020
#
################################################################################
...
'-reset_run' switch to the './fulladder_dataflow_tb.sh' script.

./fulladder_dataflow_tb.sh -reset_run
...
./fulladder_dataflow_tb.sh -noclean_files

For more information on the script, please type './fulladder_dataflow_tb.sh -help'.
