...
HD_PWD='C:/Users/lucas/Documents/fpga/lab6/lab6_1_3/lab6_1_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_line_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_line_behavior.tcl
