...
HD_PWD='C:/Users/lucas/Documents/fpga/lab6/lab6_1_3/lab6_1_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_line_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source delay_line_behavior.tcl -notrace
