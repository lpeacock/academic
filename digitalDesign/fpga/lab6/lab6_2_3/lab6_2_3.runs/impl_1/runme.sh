...
HD_PWD='C:/Users/lucas/Documents/fpga/lab6/lab6_2_3/lab6_2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count_down_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count_down_counter.tcl -notrace
