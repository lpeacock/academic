...
HD_PWD='C:/Users/lucas/Documents/fpga/lab6/lab6_1_5/lab6_1_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parallel_out_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parallel_out_shift_register.tcl
