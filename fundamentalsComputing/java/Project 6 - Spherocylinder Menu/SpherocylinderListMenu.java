...
/**
*Program to create a menu to manipulate a Spherocylinder List.
*Project 06
...
public class SpherocylinderListMenuApp {
   ...
   */
   public static void main(String[] args) throws FileNotFoundException {
      ...
      SpherocylinderList scList = new SpherocylinderList(title, list);
      Scanner userInput = new Scanner(System.in);
      String input = "";
      
      
      System.out.println("Spherocylinder List System Menu\n"
                       + "R - Read in File and Create Spherocylinder List\n"
