 ...
 */
   ...
   */
   ...
   /**
   *Method to return an int representing the value of count.
   *@return count equals the static variable count.
   */
   public static int getCount() {
      return count;
   }
   /**
   *Method to reset the value of count.
   */
   public static void resetCount() {
      count = 0;
   }
   /**
   *Method to evaluate two objects.
   @return is a boolean
